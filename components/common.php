        ...
        <div class="row"></div>
            <div class="col-12">
                ...
                <div class="d-flex flex-column w-50">
                    <a href="<?= ROOT ?>/components/edit_balance.php" class="btn btn-primary mt-4 mb-4 w-100">ADD balance</a>
                    <a href="<?= ROOT ?>/components/extrato.php" class="btn btn-primary w-100">Extrato</a>
                </div>
            </div>
        </div>
    </div>
